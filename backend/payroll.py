...
def calculate_payroll_receipt(salario_diario: float, dias_trabajados: int, pct_fondo: float = 10.0) -> dict:
    """
    Computes standard payroll with Mexican law deductions (ISR, IMSS, Fondo de Ahorro).
    """
    sueldo_bruto = salario_diario * dias_trabajados
